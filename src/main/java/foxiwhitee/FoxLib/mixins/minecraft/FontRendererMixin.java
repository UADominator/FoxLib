...
public abstract class FontRendererMixin {
    ...
    private String redirectFontCharacters(String original) {
        return "ÀÁÂÈÊËÍÓÔÕÚßãÇüİıŒœŞşŴŵžȇ\u0000\u0000\u0000\u0000\u0000\u0000\u0000 !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_õabcdefghijklmnopqrstuvwxyz{|}~ğҐґéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑªº¿®¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЇІЬЄЮЯабвгдежзийклмнопрстуфхцчшщїіьєюя";
    }
}
